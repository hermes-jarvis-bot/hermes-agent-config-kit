...
| `rules/` | 35 | 29 | 0 | 6 |
| `scripts/` | 83 | 0 | 1 | 82 |
| `skills/` | 375 | 155 | 0 | 220 |
| `templates/` | 50 | 34 | 0 | 16 |
| `workflows/` | 5 | 0 | 0 | 5 |
| **Total** | **774** | **272** | **14** | **488** |
...
_Last recomputed against upstream commit `63be9d65cd695cd8608a254d29b8b7519efc3d0a` (`upstream.lock.json`'s `last_synced_sha`)._
