...
mappings/reviewed-hooks.yaml               # reviewed-hook lane allowlist (see SECURITY.md)
PORTING_BACKLOG.md                         # omitted artefacts, next waves, and handoff plan
hermes/skills/                             # generated/adapted Hermes skills (README.md/README_RU.md catalog)
hermes/templates/                          # adapted templates (README.md/README_RU.md catalog)
hermes/hooks/                              # reviewed-hook lane guards (README.md/README_RU.md)
...
`hermes/skills/`, `hermes/templates/`, and `hermes/hooks/` each carry a browsable catalog:
`README.md` (English, `hermes/skills/README.md` regenerated by
`scripts/generate_skills_catalog.py`) and a hand-maintained `README_RU.md` translation.
