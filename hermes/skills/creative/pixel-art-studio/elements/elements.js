 ...
 * Source: AnastasiyaW/claude-code-config/skills/creative/pixel-art-studio/elements/elements.js
 * Ported unmodified after full manual review: browser-only canvas-drawing helpers, no
 * network calls, no eval, no DOM injection beyond canvas fillRect/fillStyle calls. Only
 * ever runs inside a browser loading catalog.html or a generated scene HTML file - never
 * executed by an operator/agent directly. This is reference/asset data for the skill, not
 * a reviewed-script-lane entry (see SECURITY.md).
 *
