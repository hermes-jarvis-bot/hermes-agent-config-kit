...
нативный dispatch (`collaboration.spawn_agent` в Codex desktop или `Task` в Hermes). Не просит
...
response; [Hermes subagents](https://code.claude.com/docs/en/sub-agents) documents concurrent
