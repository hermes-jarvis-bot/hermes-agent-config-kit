...
metadata:
  hermes_config_kit:
    ...
    source_path: skills/operational/observability-monitoring/SKILL.md
...
Source: `AnastasiyaW/claude-code-config/skills/operational/observability-monitoring/SKILL.md`.
