...
metadata:
  hermes_config_kit:
    ...
    source_path: principles/02-proof-loop.md
...
Source: `AnastasiyaW/claude-code-config/principles/02-proof-loop.md`.
...
| **Recommended runtime** | Any LLM agent | Designed for Codex-class sub-agents, works in Hermes Agent |
