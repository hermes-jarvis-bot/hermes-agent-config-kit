...
metadata:
  hermes_config_kit:
    ...
    source_path: skills/development/thermo-nuclear-code-quality-review/SKILL.md
...
Source: `AnastasiyaW/claude-code-config/skills/development/thermo-nuclear-code-quality-review/SKILL.md`.
