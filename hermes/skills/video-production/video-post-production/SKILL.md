...
metadata:
  hermes_config_kit:
    ...
    source_path: skills/video-production/video-post-production/SKILL.md
...
Source: `AnastasiyaW/claude-code-config/skills/video-production/video-post-production/SKILL.md`.
...
- Complex filter graphs: keep each step simple. Hermes makes subtle errors in long chains
