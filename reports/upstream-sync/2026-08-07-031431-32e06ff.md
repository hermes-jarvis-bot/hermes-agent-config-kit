# Upstream sync report: 254edfefd72bbd3a9da1921225be105686723943..32e06ff346899ac7ad62332e70c8bd79057ffd1f

Generated: 2026-08-07T03:14:31.907982+00:00
Source: `AnastasiyaW/claude-code-config` branch `main`
Base SHA: `254edfefd72bbd3a9da1921225be105686723943`
Target SHA: `32e06ff346899ac7ad62332e70c8bd79057ffd1f`

## Summary

- Commits included: 10
- Files changed/snapshotted: 21
- Generated artefacts: 231
- Missing supported sources: 0
- Manual re-approval candidates: 3
- Manual-review candidates: 12
- Unsupported candidates: 0
- Risk counts: {"high": 12, "low": 6, "medium": 3}

## Commits

- `5e4a0b8` rule: the author of a finding does not close it - measured on myself
- `30207e3` live tree: a BOM in front of the event turned the guard off
- `ed21e2b` handoff gate: a ticket you opened today is not a backlog item
- `04455a5` docs: the deferral moves to whichever form is not guarded
- `50eef51` open items: the question is a work order, not a status request
- `cafff48` launch watch: starting a job is a promise to look at it
- `d832a1d` docs: a launch is a promise to look at it
- `cea0ce2` hooks: the four new guards left no trace, so nothing could prove they fire
- `5e161cd` security: verify dependency provenance and versions
- `32e06ff` security: fail closed on registry outages and search verified alternatives
...
- `hooks/dependency-provenance-guard.py`
- `hooks/handoff-closure-audit-guard.py`
- `hooks/launch-watch-guard.py`
- `hooks/live-tree-guard.py`
- `hooks/open-items-are-work-orders.py`
- `hooks/unbuffered-progress-advisor.py`
- `scripts/dependency-alternatives.py`
- `scripts/install_hooks.py`
- `scripts/replay_retry_guard_keys.py`
- `scripts/test_dependency_provenance_guard.py`

### review

- `AGENTS.md`
- `README.md`
- `docs/a-launch-is-a-promise.md`
- `docs/finishing-what-you-started.md`
